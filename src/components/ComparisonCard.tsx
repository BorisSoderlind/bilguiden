...
const ComparisonCard = ({ slug, car1, car2, image, category, excerpt, date, index = 0 }: ComparisonCardProps) => {
  return (
      ...
      >
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="flex items-center gap-1 text-primary font-display text-sm tracking-wide group-hover:text-accent transition-colors">
              Läs mer
